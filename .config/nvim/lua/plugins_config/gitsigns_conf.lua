require("gitsigns").setup({
  ...
  on_attach = function(bufnr)
    ...
    -- Actions
    vim.keymap.set("n", "<leader>hs", require("gitsigns").stage_hunk, { buffer = bufnr, desc = "Gitsings: stage hunk" })
    vim.keymap.set("n", "<leader>hr", require("gitsigns").reset_hunk, { buffer = bufnr, desc = "Gitsings: reset hunk" })
    ...
    vim.keymap.set("n", "<leader>hd", require("gitsigns").diffthis, { buffer = bufnr, desc = "Gitsings: diff this" })
    ...
    vim.keymap.set({
      "o",
      "x",
    }, "ih", ":<C-U>Gitsigns select_hunk<CR>", { buffer = bufnr, desc = "Gitsings: select hunk" })
  end,
})
